    ...
    <section id="contact" class="h-m-screen lg:!h-screen pt-[8vh] lg:!pt-0 pb-20 flex flex-col justify-around z-20 lg:!w-full">
        ...
        <div class="z-20 h-full flex flex-col w-full justify-between">
            <form @submit.prevent="submitForm" ref="contactForm" id="form" method="POST" class="mx-auto mt-10 max-w-xl sm:mt-20 w-full">
                <div class="w-full">
                    <div class="w-full flex flex-col justify-center">
                        <label for="name" class="block text-sm font-semibold leading-6 text-gray-900 px-4 lg:!px-0 ml-[8%] lg:ml-0">{{ $t('name') }}</label>
                    ...
                    <div class="mt-2 w-full flex flex-col justify-center">
                        ...
                        <div class="mt-1 w-full flex justify-center">
                            <input v-model="email" type="email" name="email" id="email" autocomplete="email" class="block w-[80%] lg:!w-full rounded-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 mx-4 lg:!mx-0" required>
                        </div>
                    </div>
                    <div class="mt-2 w-full flex flex-col justify-center">
                        <label for="phone" class="block text-sm font-semibold leading-6 text-gray-900 px-4 lg:!px-0 ml-[8%] lg:ml-0 mt-1">{{ $t('phone') }}</label>
                        <div class="mt-1 w-full flex justify-center">
            ...
            <div class="w-full flex justify-center mt-16">
                <p class="text-xs sm:text-sm">&copy; 2023 - {{ $t('footer') }} - Mathieu Le Puil | <router-link to="/mentions-legales" class="text-xs sm:text-sm hover:text-my-purple">{{ $t('mentions') }}</router-link></p>
            </div>
        </div>
    </section>
</template>
