        ...
        <div class="flex flex-wrap mx-[10%]">
            <div class="w-80 mt-14 m-auto lg:mt-16 max-w-full">
                ...
                <div class="bg-white shadow-2xl rounded-b-3xl pb-8">
                    ...
                    <div class="w-5/6 m-auto">
                        <p class="text-center text-gray-500 pt-5"><br> Portfolio construit pour développer mon image lors de ma recherche d'alternance en tant que développeur web.<br><br></p>
                    </div>
            ...
            <div class="w-80 mt-14 m-auto lg:mt-16 max-w-full">
                ...
                <div class="bg-white shadow-2xl rounded-b-3xl pb-8">
                    ...
                    <div class="w-5/6 m-auto">
                        <p class="text-center text-gray-500 pt-5">Site développé pour ma communauté sur un jeu vidéo. Nous vendions par discord des objets du jeux contre de l'argent du jeu. Le site a surtout été construit pour m'entrainer.</p>
                    </div>
                    <div class="flex justify-around text-2xl mt-5">
                        <i class="fa-brands fa-html5"></i>
                        <i class="fa-brands fa-css3-alt"></i>
            ...
            <div class="w-80 mt-14 m-auto lg:mt-16 max-w-full">
                ...
                <div class="bg-white shadow-2xl rounded-b-3xl pb-8">
                    ...
                    <div class="w-5/6 m-auto">
                        <p class="text-center text-gray-500 pt-5"><br>Popeye est l'entreprise de mon alternance. Je m'occupe de la refonte du site web ainsi que la création d'outils autour de celui-ci.<br><br></p>
                    </div>
                    <div class="flex justify-around text-2xl mt-5">
                        <i class="fa-brands fa-html5"></i>
