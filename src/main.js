...
const i18n = createI18n({
    ...
    messages: {
        en: {
            ...
            pocmagiline: "During my studies, we had to do a proof of concept in relation to a company. We therefore made a 3D pool configurator for Magiline.",
        ...
        fr: {
            ...
            pocmagiline: "Lors de mes études, nous devions faire une preuve de concept en relation avec une entreprise. Nous avons donc fait un configurateur 3D de piscine pour Magiline.",
